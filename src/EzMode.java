...
public class EzMode extends Questions {

  // Plans to make this inherit from a bigger questionaire template class

  public static void Eazy(Scanner peazy) {
    // Eazy is the header, with peazy as the parameter.
    System.out.println("We'll go eazy on you since you're new to the progra" + 
    "m.");
    System.out.println("The following questions will help you with character" + 
    " creation.");
    ...
    if (charName.equalsIgnoreCase("Bean")) {
      ...
      // The .equalsIgnoreCase method tells the code to accept what is inside of
      // the ()'s
    ...
    System.out.println("4. How tall is " + charName + "? (Assume units are" + 
    " in feet. Type " + "numbers please.)");
    double charHeight = 0;
    ...
    // The above statement returns an error if the user inputs anything but
    // a number
    peazy.nextLine();
    System.out.println("5. Where does " + charName + " prefer to be in the heat"
    + " of battle?");
    ...
    while (charPosition.isEmpty()) {
      ...
      // Later I will add while loops to all of the input spots to ensure the
    ...
    System.out.println(charName + "_" + charGender);
    // Replace this with a table that prints all of
    // the user's inputs
    // peazy.close();
  }
}
